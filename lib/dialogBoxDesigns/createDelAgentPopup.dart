...
class CreateDelAgentPopup extends State{
  @override
        ...
        child: new Center(
          child: Column(
            ...
            children: [
              ...
              CustomStyle.getLogoImages('assets/delagent.png', 214, 168),
              SizedBox(height: 22,),

              Text(CustomString.createagent,style: CustomStyle.blackNormalCust_14,textAlign: TextAlign.center,softWrap: true,maxLines: 2,),
              ...
              InkWell(
                ...
                child: BtnContinue(CustomString.createNew, context,'CreateAgentPopup'),
              ),
              SizedBox(height: 20,),
