...
class ReturnProductReasonsPopup extends State{
  @override
            ...
            children: [
                ...
                children: [
                  Flexible(
                    ...
                    child:Row(
                      ...
                      children: [
                        Text(CustomString.returnProduct,style: CustomStyle.boldValueText,
              ...
              Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(CustomString.dmsg_selreason_return,style: CustomStyle.textsemiboldblackTitle,textAlign: TextAlign.left,),
                      SizedBox(height: 8,),
              ...
              RadioGroupDesign(verticalGroupValue:CustomString.value_reasons_returnproduct,status:CustomString.reasons_returnproduct,direction: Axis.vertical,),
              SizedBox(height: 20,),

              BtnContinue(CustomString.submit, context,'ReturnProdReasonsPopup'),
              SizedBox(height: 20,),
