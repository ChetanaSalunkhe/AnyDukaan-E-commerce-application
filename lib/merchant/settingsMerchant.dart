...
class SettingsMerchant extends State{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: CustomColors.background_lightblue,
      appBar:ProfileAppBarCommon('Mukesh Kumar','Naya Kirana Bazaar','assets/dummyboyimg.jpg'),
          ...
          child: Column(
            ...
            children: [
              InkWell(
                onTap: (){
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context)=>SecondRoute(callFrom: 'Setmerch_profile',params: 'ShopDetails',)));
                },
                child:getmyAccountCard(Icons.home_work_outlined,CustomString.shopDtls,Icons.arrow_forward),
              ),
              SizedBox(height: 3,),
              ...
              InkWell(
                onTap: (){
                  Navigator.push(context,
                  MaterialPageRoute(builder: (context)=>SecondRoute(callFrom: 'Setmerch_paypref',)));
                },
                child:getmyAccountCard(Icons.payments_sharp,CustomString.payPref,Icons.arrow_forward),
              ),
              SizedBox(height: 3,),

              getmyAccountCard(Icons.share,CustomString.shareApp,Icons.arrow_forward),
              SizedBox(height: 3,),
              ...
              InkWell(
                ...
                child:getmyAccountCard(Icons.policy_outlined,CustomString.privacyPolicy,Icons.arrow_forward),
              ),
              SizedBox(height: 3,),
              ...
              InkWell(
                onTap: (){
                  Navigator.push(context, 
                  MaterialPageRoute(builder: (context)=>SecondRoute(callFrom: 'Acc_Notification',params: 'Merchant',)));
                },
                child: Container(
                  height:54,
              ...
              getmyAccountCard(Icons.logout,CustomString.logout,Icons.arrow_forward),
            ],
