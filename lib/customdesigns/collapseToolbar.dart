...
/*Created by Chetana*/
class CollapsedToolbarWithoutSearch extends StatelessWidget with PreferredSizeWidget{

  Size preferredSize;
  String title="";

  CollapsedToolbarWithoutSearch(this.title, {Key key}): preferredSize = Size.fromHeight(64),super(key: key);
